export const lessons: any[] = [
  {
    ...
    exampleCommand: '',
    objective:
      'Understand that Git is a version control system that tracks changes to your code',
    hint: 'Git is like a time machine - it lets you save checkpoints and go back anytime!',
    practiceTask:
      "Read through this lesson carefully. No commands needed yet - we're building your foundation!",
    isFoundation: true,
    isPaid: false,
    order: 1,
  ...
  },
  {
    ...
    description:
      'Learn why millions of developers rely on Git every single day',
    explanation:
    ...
    exampleCommand: '',
    objective:
      'Understand how Git protects your work and enables collaboration',
    hint: 'Git gives you confidence to experiment because you can always go back!',
    practiceTask:
      "Think about a time you wished you could undo changes - that's why we need Git!",
    isFoundation: true,
    isPaid: false,
    order: 2,
    category: 'Git Concepts',
  },
  {
    ...
    exampleCommand: '',
    objective:
      'Know the difference between Git (the tool) and GitHub (the website)',
    hint: 'Git = tool on your computer. GitHub = website for sharing code online.',
    practiceTask:
      "Remember: You need Git to use GitHub, but you don't need GitHub to use Git!",
    isFoundation: true,
    isPaid: false,
    order: 3,
    category: 'Git Concepts',
  },
  {
    ...
    exampleCommand: '',
    objective:
      'Understand that a repository is a tracked project folder with a hidden .git folder',
    hint: "Repository = Your project folder + Git's magic .git folder inside it",
    practiceTask:
      "Imagine your project folder as a notebook that Git is photographing - that's a repository!",
    isFoundation: true,
    isPaid: false,
    order: 4,
    category: 'Git Concepts',
  },
  {
    ...
    description:
      "Discover how Git uses snapshots to remember your project's history",
    explanation:
    ...
    exampleCommand: '',
    objective:
      'Understand that Git saves snapshots (commits) of your project at specific moments',
    hint: 'Commit = Snapshot + Message. You decide when to save a checkpoint!',
    practiceTask:
      "Think about when you'd want to save a checkpoint in your project - that's when you commit!",
    isFoundation: true,
    isPaid: false,
    order: 5,
    category: 'Git Concepts',
  },
  {
    ...
    description:
      "Master the essential vocabulary you'll use every day with Git",
    explanation:
    ...
    exampleCommand: '',
    objective:
      'Learn the basic vocabulary that makes Git communication possible',
    hint: "Don't memorize - these terms will become natural with practice!",
    practiceTask:
      'Once you understand these terms, Git commands will make much more sense!',
    isFoundation: true,
    isPaid: false,
    order: 6,
    category: 'Git Concepts',
